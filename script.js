    ...
    container.innerHTML = simulacrosData.map(item => `
        <div class="bg-cardDark rounded-2xl border border-cardBorder ${item.borderHover} overflow-hidden flex flex-col transition-all duration-700 ease-in-out">
            ...
            <div class="p-6 flex-1 flex flex-col justify-between">
                ...
                <div class="space-y-3">
                    <a href="#" target="_blank" class="w-full bg-sidebar hover:bg-gray-800 text-textLight py-3 rounded-xl font-semibold transition-colors flex items-center justify-center gap-2 border border-cardBorder">
                        <i class="fa-regular fa-file-pdf ${item.iconClass} text-lg"></i> Ver Cuadernillo
                    </a>
                    <a href="#" target="_blank" class="w-full ${item.btnClass} text-white py-3 rounded-xl font-semibold transition-all duration-300 flex items-center justify-center gap-2">
